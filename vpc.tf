locals {
  ...
  databricks_private_subnets_poc = [
    "10.16.64.0/24", # AZ a
    "10.16.65.0/24", # AZ b
    "10.16.66.0/24", # AZ c
    "10.16.67.0/24", # AZ d
...
module "vpc" {
  ...
  private_subnets = concat(
    ...
    local.databricks_private_subnets_staging,     # indices 6–11
    local.databricks_private_subnets_production,  # indices 12–17
    local.databricks_private_subnets_poc,         # indices 18–23
